...
from model.global_alignment import *

# ----------------------------------------------------------------------------------------------------------------------


class KBandAlignment(GlobalAlignment):
    ...
    def validate_sizes(self):
        if len(self.v_text) != len(self.h_text):
            raise Exception("Para este alineamiento se deben específicar cadenas del mismo tamaño")
